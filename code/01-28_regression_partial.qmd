...
# Creating predictions
#nd <- reg_dfw %>%
#  summarise(sr_ksha = seq(min(sr_ksha), max(sr_ksha), length.out = 100)) %>%
#  tidyr::unnest(sr_ksha)
...
# if that AIC just change below 2 points, it means it's not significant different.
```
